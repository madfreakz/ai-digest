...
export const COMPANIES: TrackedCompany[] = [
  ...
  { name: "Genesis AI",            beat: "Physical AI", tier: 1, dealVector: ["strategic_partner", "potential_customer"],     vcBacked: [], addedAt: "2024-01-01" },
  { name: "Mind Robotics",         beat: "Physical AI", tier: 1, dealVector: ["strategic_partner", "potential_customer"],     vcBacked: [], addedAt: "2024-01-01" },
  { name: "Bedrock Robotics",      beat: "Physical AI", tier: 1, dealVector: ["strategic_partner", "potential_customer"],     vcBacked: [], addedAt: "2024-01-01" },
  ...
  { name: "Parallel Web Systems", beat: "AI Infrastructure", tier: 1, dealVector: ["technology_dependency", "strategic_partner"], vcBacked: [], addedAt: "2024-01-01", domain: "parallelwebsystems.com" },
